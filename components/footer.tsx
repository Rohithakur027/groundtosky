        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-4">
            ...
            <p className="text-gray-600 dark:text-gray-400">
              Discover the serenity of Tirthan Valley – A hidden gem in the Himalayas.
            </p>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li className="flex items-center gap-3">
                ...
                <span className="text-gray-600 dark:text-gray-400">info@tirthanvalley.com</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="mt-12 pt-8 border-t border-gray-200 dark:border-gray-800">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 items-center">
            <p className="text-center md:text-left text-sm text-gray-600 dark:text-gray-400">
              &copy; {new Date().getFullYear()} Tirthan Valley. All rights reserved.
            </p>
